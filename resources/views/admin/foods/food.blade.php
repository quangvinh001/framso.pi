...
@section('css')
    <style>
      ...
      background: linear-gradient(135deg, #71b7e6, #9b59b6);
        ...
        .food-details .input-box input:focus,
        .food-details .input-box input:valid {
            border-color: #9b59b6;
        }
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th @extends('admin.layout.master')
                                @section('title')
                                    {{ $title }}
                                @endsection
                                @section('css')
                                                ...
                                                <div class="activity-data">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <form action="{{ route('foods.destroy', ['food' => $food->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                    <tr class="activity-data">
                                                                        ...
                                                                        <td><img src="/build/images/{{$food->image}}" alt="" style="width: 120px;"></a></td>
                            ...
                            <form action="{{ route('foods.destroy', ['food' => $food->id]) }}"
                                ...
                                @method('delete')
                                    <tr class="activity-data">
                                        ...
                                        <td class="data-list">{{ $food->name }}</td>
                                        <td class="data-list">{{ $food->email }}</td>
                                        <td class="data-list">****************</td>
                                        <td class="data-list">{{ $food->phone }}</td>
                                        <td class="data-list">{{ $food->address }}</td>
                                        <td class="data-list">{{ $food->id_role }}</td>
                                        <td class="data-list"> <button type="button" class="btn btn-success "
                                                data-bs-toggle="modal" data-bs-target="#edit-food">
                                                <i class="uil uil-edit"></i>
                                            </button>
